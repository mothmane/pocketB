...
import ma.oth.domain.Report;
import ma.oth.repository.ReportRepository;
...
public class ReportResourceIntTest {
    ...
    private static final ReportType DEFAULT_TYPE = ReportType.STOLEN;
    private static final ReportType UPDATED_TYPE = ReportType.LOST;
